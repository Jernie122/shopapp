      ...
      {[1, 2, 3, 4, 5].map((star) => (
        <span
          ...
          style={{
            ...
            color:
              star <= (hover || rating) ? '#f5b042' : '#e2d8cf',
            transition: '0.1s',
          }}
...
function ProductPage() {
  ...
  if (!product)
    return (
      <div className="loader-container">
        <div className="loader">Product not found.</div>
      </div>
    );
          ...
          <div className="product-card">
            ...
            <div className="product-details">
              ...
              <div className="rating-display">
                <StarRating
                  rating={Math.round(product.ratings || 0)}
                  interactive={false}
                />
              ...
              <p className="seller-info">
                🏪 sold by: {product.seller?.storeName || product.seller?.name || 'Unknown'}
              </p>
              <button
                ...
                <div className="review-form">
                  ...
                  <form onSubmit={submitReview}>
                    <div style={{ marginBottom: '0.75rem' }}>
                      ...
                      <StarRating
                        rating={rating}
                        onRate={(val) => setRating(Number(val))}
                        interactive={true}
                      />
                    </div>
                    <textarea
                    ...
                    {reviewMsg && (
                      <div
                        className={`review-message ${
                          reviewMsg.includes('submitted') ? 'success' : 'error'
                        }`}
                      >
                        {reviewMsg}
                      </div>
