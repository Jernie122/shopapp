  ...
  return (
    <>
      <style>{`
        ...
        .orders-wrap { min-height: 90vh; background: #0e0a1f; padding: 2rem; font-family: 'Roboto Mono', monospace; }
        ...
        .order-card {
          background: rgba(255,170,68,0.05); border: 1px solid #ffaa4466;
        ...
        .order-item-img { width: 50px; height: 50px; object-fit: cover; border-radius: 6px; background: #1a1030; }
        ...
        .order-footer { display: flex; justify-content: space-between; align-items: center; margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #ffaa4433; }
        ...
        .shop-btn {
          padding: 10px 24px; background: transparent; color: #ff44aa;
          border: 1px solid #ff44aa; border-radius: 30px; cursor: pointer;
